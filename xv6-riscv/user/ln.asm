...
main(int argc, char *argv[])
{
  ...
  14:	98058593          	addi	a1,a1,-1664 # 990 <malloc+0x102>
  18:	4509                	li	a0,2
  1a:	796000ef          	jal	7b0 <fprintf>
    exit(1);
  1e:	4505                	li	a0,1
  ...
  42:	96a58593          	addi	a1,a1,-1686 # 9a8 <malloc+0x11a>
  46:	4509                	li	a0,2
  48:	768000ef          	jal	7b0 <fprintf>
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 48e:	53e50513          	addi	a0,a0,1342 # 9c8 <digits>
 492:	883e                	mv	a6,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 724:	2a8b8b93          	addi	s7,s7,680 # 9c8 <digits>
 ...
 786:	23e90913          	addi	s2,s2,574 # 9c0 <malloc+0x132>
        for(; *s; s++)
