...
main(int argc, char *argv[])
{
  ...
  14:	97058593          	addi	a1,a1,-1680 # 980 <malloc+0xfa>
  18:	4509                	li	a0,2
  1a:	78e000ef          	jal	7a8 <fprintf>
    exit(1);
  1e:	4505                	li	a0,1
  ...
  42:	95a58593          	addi	a1,a1,-1702 # 998 <malloc+0x112>
  46:	4509                	li	a0,2
  48:	760000ef          	jal	7a8 <fprintf>
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 486:	53650513          	addi	a0,a0,1334 # 9b8 <digits>
 48a:	883e                	mv	a6,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 71c:	2a0b8b93          	addi	s7,s7,672 # 9b8 <digits>
 ...
 77e:	23690913          	addi	s2,s2,566 # 9b0 <malloc+0x12a>
        for(; *s; s++)
