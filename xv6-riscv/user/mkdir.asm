...
main(int argc, char *argv[])
{
  ...
  40:	98458593          	addi	a1,a1,-1660 # 9c0 <malloc+0x100>
  44:	4509                	li	a0,2
  46:	79c000ef          	jal	7e2 <fprintf>
    exit(1);
  4a:	4505                	li	a0,1
  ...
  56:	98658593          	addi	a1,a1,-1658 # 9d8 <malloc+0x118>
  5a:	4509                	li	a0,2
  5c:	786000ef          	jal	7e2 <fprintf>
      break;
    }
  }
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 4b0:	0805c363          	bltz	a1,536 <printint+0x94>
  neg = 0;
 4b4:	4881                	li	a7,0
 4b6:	fb840693          	addi	a3,s0,-72
    x = -xx;
  } else {
    x = xx;
  }
 ...
 4de:	fec773e3          	bgeu	a4,a2,4c4 <printint+0x22>
  if(neg)
 4e2:	00088b63          	beqz	a7,4f8 <printint+0x56>
    buf[i++] = '-';
 4e6:	fd078793          	addi	a5,a5,-48
 4ea:	97a2                	add	a5,a5,s0
 4ec:	02d00713          	li	a4,45
 4f0:	fee78423          	sb	a4,-24(a5)
 4f4:	0028079b          	addiw	a5,a6,2

  while(--i >= 0)
 4f8:	02f05a63          	blez	a5,52c <printint+0x8a>
 4fc:	fc26                	sd	s1,56(sp)
 4fe:	f44e                	sd	s3,40(sp)
 500:	fb840713          	addi	a4,s0,-72
 504:	00f704b3          	add	s1,a4,a5
 508:	fff70993          	addi	s3,a4,-1
 50c:	99be                	add	s3,s3,a5
 50e:	37fd                	addiw	a5,a5,-1
 510:	1782                	slli	a5,a5,0x20
 512:	9381                	srli	a5,a5,0x20
 514:	40f989b3          	sub	s3,s3,a5
    putc(fd, buf[i]);
 518:	fff4c583          	lbu	a1,-1(s1)
 51c:	854a                	mv	a0,s2
 51e:	f67ff0ef          	jal	484 <putc>
  while(--i >= 0)
 522:	14fd                	addi	s1,s1,-1
 524:	ff349ae3          	bne	s1,s3,518 <printint+0x76>
 ...
 534:	8082                	ret
    x = -xx;
 536:	40b005b3          	neg	a1,a1
    neg = 1;
 53a:	4885                	li	a7,1
    x = -xx;
 53c:	bfad                	j	4b6 <printint+0x14>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 54c:	28090663          	beqz	s2,7d8 <vprintf+0x29a>
 ...
 594:	22090a63          	beqz	s2,7c8 <vprintf+0x28a>
    c0 = fmt[i] & 0xff;
 ...
 5b6:	00274603          	lbu	a2,2(a4)
      if(c0 == 'd'){
 5ba:	05878363          	beq	a5,s8,600 <vprintf+0xc2>
      } else if(c0 == 'l' && c1 == 'd'){
 5be:	05978d63          	beq	a5,s9,618 <vprintf+0xda>
 ...
 5c6:	0ee78763          	beq	a5,a4,6b4 <vprintf+0x176>
 ...
 5ce:	12e78963          	beq	a5,a4,700 <vprintf+0x1c2>
 ...
 5d6:	14e78e63          	beq	a5,a4,732 <vprintf+0x1f4>
        printptr(fd, va_arg(ap, uint64));
      } else if(c0 == 'c'){
 5da:	06300713          	li	a4,99
 5de:	18e78e63          	beq	a5,a4,77a <vprintf+0x23c>
        putc(fd, va_arg(ap, uint32));
      } else if(c0 == 's'){
 5e2:	07300713          	li	a4,115
 5e6:	1ae78463          	beq	a5,a4,78e <vprintf+0x250>
 ...
 5ee:	04e79563          	bne	a5,a4,638 <vprintf+0xfa>
        putc(fd, '%');
 5f2:	02500593          	li	a1,37
 5f6:	855a                	mv	a0,s6
 5f8:	e8dff0ef          	jal	484 <putc>
 ...
 60c:	855a                	mv	a0,s6
 60e:	e95ff0ef          	jal	4a2 <printint>
 612:	8bca                	mv	s7,s2
      state = 0;
 614:	4981                	li	s3,0
 616:	bf8d                	j	588 <vprintf+0x4a>
      } else if(c0 == 'l' && c1 == 'd'){
 618:	06400793          	li	a5,100
 61c:	02f68963          	beq	a3,a5,64e <vprintf+0x110>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
 620:	06c00793          	li	a5,108
 624:	04f68263          	beq	a3,a5,668 <vprintf+0x12a>
      } else if(c0 == 'l' && c1 == 'u'){
 628:	07500793          	li	a5,117
 62c:	0af68063          	beq	a3,a5,6cc <vprintf+0x18e>
      } else if(c0 == 'l' && c1 == 'x'){
 630:	07800793          	li	a5,120
 634:	0ef68263          	beq	a3,a5,718 <vprintf+0x1da>
        putc(fd, '%');
 638:	02500593          	li	a1,37
 63c:	855a                	mv	a0,s6
 63e:	e47ff0ef          	jal	484 <putc>
        putc(fd, c0);
 642:	85ca                	mv	a1,s2
 644:	855a                	mv	a0,s6
 646:	e3fff0ef          	jal	484 <putc>
      state = 0;
 64a:	4981                	li	s3,0
 64c:	bf35                	j	588 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 1);
 ...
 664:	4981                	li	s3,0
        i += 1;
 666:	b70d                	j	588 <vprintf+0x4a>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
 668:	06400793          	li	a5,100
 66c:	02f60763          	beq	a2,a5,69a <vprintf+0x15c>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'u'){
 670:	07500793          	li	a5,117
 674:	06f60963          	beq	a2,a5,6e6 <vprintf+0x1a8>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'x'){
 678:	07800793          	li	a5,120
 67c:	faf61ee3          	bne	a2,a5,638 <vprintf+0xfa>
        printint(fd, va_arg(ap, uint64), 16, 0);
 ...
 6c0:	855a                	mv	a0,s6
 6c2:	de1ff0ef          	jal	4a2 <printint>
 6c6:	8bca                	mv	s7,s2
      state = 0;
 6c8:	4981                	li	s3,0
 6ca:	bd7d                	j	588 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 0);
 ...
 70c:	855a                	mv	a0,s6
 70e:	d95ff0ef          	jal	4a2 <printint>
 712:	8bca                	mv	s7,s2
      state = 0;
 714:	4981                	li	s3,0
 716:	bd8d                	j	588 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 16, 0);
 ...
 740:	855a                	mv	a0,s6
 742:	d43ff0ef          	jal	484 <putc>
  putc(fd, 'x');
 746:	07800593          	li	a1,120
 74a:	855a                	mv	a0,s6
 74c:	d39ff0ef          	jal	484 <putc>
 750:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
 752:	00000b97          	auipc	s7,0x0
 756:	2aeb8b93          	addi	s7,s7,686 # a00 <digits>
 75a:	03c9d793          	srli	a5,s3,0x3c
 75e:	97de                	add	a5,a5,s7
 760:	0007c583          	lbu	a1,0(a5)
 764:	855a                	mv	a0,s6
 766:	d1fff0ef          	jal	484 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
 76a:	0992                	slli	s3,s3,0x4
 76c:	397d                	addiw	s2,s2,-1
 76e:	fe0916e3          	bnez	s2,75a <vprintf+0x21c>
        printptr(fd, va_arg(ap, uint64));
 772:	8bea                	mv	s7,s10
      state = 0;
 774:	4981                	li	s3,0
 776:	6d02                	ld	s10,0(sp)
 778:	bd01                	j	588 <vprintf+0x4a>
        putc(fd, va_arg(ap, uint32));
 77a:	008b8913          	addi	s2,s7,8
 77e:	000bc583          	lbu	a1,0(s7)
 782:	855a                	mv	a0,s6
 784:	d01ff0ef          	jal	484 <putc>
 788:	8bca                	mv	s7,s2
      state = 0;
 78a:	4981                	li	s3,0
 78c:	bbf5                	j	588 <vprintf+0x4a>
        if((s = va_arg(ap, char*)) == 0)
 78e:	008b8993          	addi	s3,s7,8
 792:	000bb903          	ld	s2,0(s7)
 796:	00090f63          	beqz	s2,7b4 <vprintf+0x276>
        for(; *s; s++)
 79a:	00094583          	lbu	a1,0(s2)
 79e:	c195                	beqz	a1,7c2 <vprintf+0x284>
          putc(fd, *s);
 7a0:	855a                	mv	a0,s6
 7a2:	ce3ff0ef          	jal	484 <putc>
        for(; *s; s++)
 7a6:	0905                	addi	s2,s2,1
 7a8:	00094583          	lbu	a1,0(s2)
 7ac:	f9f5                	bnez	a1,7a0 <vprintf+0x262>
        if((s = va_arg(ap, char*)) == 0)
 7ae:	8bce                	mv	s7,s3
      state = 0;
 7b0:	4981                	li	s3,0
 7b2:	bbd9                	j	588 <vprintf+0x4a>
          s = "(null)";
 7b4:	00000917          	auipc	s2,0x0
 7b8:	24490913          	addi	s2,s2,580 # 9f8 <malloc+0x138>
        for(; *s; s++)
 7bc:	02800593          	li	a1,40
 7c0:	b7c5                	j	7a0 <vprintf+0x262>
        if((s = va_arg(ap, char*)) == 0)
 7c2:	8bce                	mv	s7,s3
      state = 0;
 7c4:	4981                	li	s3,0
 7c6:	b3c9                	j	588 <vprintf+0x4a>
