...
00000000000004f4 <free>:
 ...
 4fa:	ff050693          	addi	a3,a0,-16 # ff0 <__BSS_END__+0x578>
 4fe:	00000797          	auipc	a5,0x0
 502:	5627b783          	ld	a5,1378(a5) # a60 <freep>
 ...
 56c:	4ef73c23          	sd	a5,1272(a4) # a60 <freep>
 570:	6422                	ld	s0,8(sp)
...
0000000000000576 <malloc>:
 ...
 596:	4ce53503          	ld	a0,1230(a0) # a60 <freep>
 ...
 5c6:	49e90913          	addi	s2,s2,1182 # a60 <freep>
 5ca:	5afd                	li	s5,-1
 ...
 5d2:	e456                	sd	s5,8(sp)
 5d4:	e05a                	sd	s6,0(sp)
 5d6:	80c18793          	addi	a5,gp,-2036 # a68 <base>
 5da:	00000717          	auipc	a4,0x0
 5de:	48f73323          	sd	a5,1158(a4) # a60 <freep>
 5e2:	e39c                	sd	a5,0(a5)
 ...
 64c:	40a73c23          	sd	a0,1048(a4) # a60 <freep>
