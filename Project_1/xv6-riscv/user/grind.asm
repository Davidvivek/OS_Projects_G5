...
go(int which_child)
{
  ...
  mkdir("grindir");
      ...
      92:	371000ef          	jal	c02 <mkdir>
  if(chdir("grindir") != 0){
      96:	00001517          	auipc	a0,0x1
      9a:	0da50513          	addi	a0,a0,218 # 1170 <malloc+0xfa>
      9e:	36d000ef          	jal	c0a <chdir>
  ...
  int fd = -1;
    ...
    int what = rand() % 23;
     ...
     17a:	271000ef          	jal	bea <unlink>
      chdir("/");
     17e:	00001517          	auipc	a0,0x1
     182:	02250513          	addi	a0,a0,34 # 11a0 <malloc+0x12a>
     186:	285000ef          	jal	c0a <chdir>
     ...
     390:	bb9d                	j	106 <go+0x92>
        kill(getpid());
     392:	089000ef          	jal	c1a <getpid>
     396:	035000ef          	jal	bca <kill>
        exit(0);
     39a:	4501                	li	a0,0
...
iter()
{
  ...
  exit(0);
    ...
    kill(pid1);
     89a:	8526                	mv	a0,s1
     89c:	32e000ef          	jal	bca <kill>
    kill(pid2);
     8a0:	854a                	mv	a0,s2
     8a2:	328000ef          	jal	bca <kill>
